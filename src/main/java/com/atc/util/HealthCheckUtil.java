 ...
 *
 */
public class HealthCheckUtil implements Callable
{
...
//		else if("sftp".equals(conType))
		...
		else if((!"".equals(conType)&&conType!=null)&&(conType.substring(0, conType.indexOf("."))).equalsIgnoreCase("ws"))
			health = CheckWebServiceConnection(paramMap);
...
private String CheckWebServiceConnection(Map<String,String> paramMap){
	String path = paramMap.get("url");
